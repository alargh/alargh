...
- **Ray-based Diffusion Pipeline:** Implemented DDPM with classifier-free guidance using UNet and Ray (Data, Train, Serve) for distributed training and inference.
...
🔗 **LinkedIn**: [LinkedIn](https://www.linkedin.com/in/albert-arnautov-b6a2572bb/))
